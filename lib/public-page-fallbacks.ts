    ...
    sections: [
      ...
      },
      {
        ...
        content: {
          ...
          stats: [
            ...
            { id: 's3', number: '98', unit: '%', label: 'On-time delivery rate' },
          ],
        },
      },
      {
        ...
        content: {
          ...
          description: 'A full-spectrum model designed for pharmaceutical growth and reliability.',
          cardsPerRow: 3,
          cards: [
            {
              id: 'c1',
              title: 'Commercial Operations',
              description: 'Strategic brand positioning and in-market execution.',
            },
            {
              id: 'c2',
              title: 'Distribution Excellence',
              description: 'Cold-chain enabled logistics from warehouse to last mile.',
            },
            {
              id: 'c3',
              title: 'Regulatory Enablement',
              description: 'Submission, approval, and lifecycle support with local expertise.',
            },
          ],
        },
      },
      {
        ...
        content: {
          ...
          description: 'Let us build a growth plan tailored to your portfolio and markets.',
          ...
          features: [
            {
              ...
              icon: '🎯',
              title: 'Vision',
              description: 'To be the most trusted pharmaceutical growth partner in the region.',
            },
            {
              id: 'f2',
              icon: '🤝',
              title: 'Mission',
              description: 'Deliver safe, compliant, and accessible healthcare solutions at scale.',
            },
            {
              id: 'f3',
              icon: '🛡️',
              title: 'Values',
              description: 'Integrity, patient focus, accountability, and continuous improvement.',
            },
          ],
        },
      },
    ...
    sections: [
      {
        ...
        content: {
          ...
          subtitle: 'From market strategy to execution, all under one quality-driven operating model.',
          overlayOpacity: 50,
          backgroundImage: {
            url: '/file.svg',
          },
      ...
      },
      {
        ...
        content: {
          ...
          cardsPerRow: 3,
          cards: [
            { id: 'sc1', title: 'Regulatory Affairs', description: 'End-to-end dossier and authority support.' },
            { id: 'sc2', title: 'Commercial Planning', description: 'Launch strategy and demand forecasting.' },
            { id: 'sc3', title: 'Supply Chain', description: 'Controlled infrastructure and distribution visibility.' },
          ],
        },
      },
      {
    ...
    sections: [
      ...
      },
      {
        ...
        content: {
          ...
          layout: 'list',
          features: [
            { id: 'cf1', icon: '✅', title: 'GxP Alignment', description: 'Operating standards aligned with recognized quality systems.' },
            { id: 'cf2', icon: '📋', title: 'Regulatory Oversight', description: 'Proactive risk management and documentation controls.' },
            { id: 'cf3', icon: '⚖️', title: 'Ethics Commitment', description: 'Transparent, accountable, and patient-first conduct.' },
          ],
        },
      },
      {
        ...
        content: {
          ...
          description: 'Our team can support compliant market entry and lifecycle continuity.',
    ...
    sections: [
      {
        ...
        content: {
          ...
          subtitle: 'A local partner with strategic access, execution rigor, and long-term commitment.',
      ...
      },
      {
        ...
        content: {
          ...
          stats: [
            { id: 'ps1', number: '95', unit: '%', label: 'Portfolio retention rate' },
            { id: 'ps2', number: '30+', label: 'Strategic brands supported' },
            { id: 'ps3', number: '12', label: 'Markets with active access programs' },
          ],
        },
      },
      {
        ...
        content: {
          ...
          description: 'Tell us about your portfolio and growth goals. We will respond with a practical market strategy.',
...
const AR_FALLBACKS: Record<string, FallbackPage> = {
  home: {
    ...
    metaDescription: 'داميرا فارما تقدم حلول توزيع دوائي وخدمات صحية موثوقة في المنطقة مع التزام قوي بالجودة.',
    sections: [
      {
        id: 'home-hero-ar',
        type: SectionType.HERO,
        ...
        content: {
          ...
          subtitle: 'نربط الابتكار الصحي العالمي بخبرة السوق المحلية لتحقيق نتائج أفضل للمرضى.',
      ...
      },
      {
        ...
        content: {
          ...
          stats: [
            ...
            { id: 'as3', number: '98', unit: '%', label: 'نسبة الالتزام بالتسليم' },
          ],
        },
      },
      {
  ...
  about: {
    ...
    metaDescription: 'تعرف على رؤية داميرا فارما ورسالتها وقيمها في بناء نموذج دوائي قائم على الجودة والمسؤولية.',
    sections: [
      {
        id: 'about-text-ar',
        type: SectionType.TEXT,
        ...
        content: {
          ...
          features: [
            ...
            },
            {
              ...
              icon: '🤝',
              title: 'الرسالة',
              description: 'تقديم حلول صحية آمنة ومتوافقة ومتاحة على نطاق واسع.',
            },
          ],
        },
      },
    ...
    sections: [
      {
        ...
        content: {
          ...
          subtitle: 'من الاستراتيجية حتى التنفيذ ضمن نموذج تشغيلي قائم على الجودة.',
          overlayOpacity: 50,
          backgroundImage: {
            url: '/file.svg',
          },
      ...
      },
      {
        ...
        content: {
          ...
          cardsPerRow: 3,
          cards: [
            { id: 'asc1', title: 'الشؤون التنظيمية', description: 'دعم متكامل للتسجيل والاعتماد.' },
            { id: 'asc2', title: 'التخطيط التجاري', description: 'استراتيجية إطلاق وتنبؤ دقيق بالطلب.' },
            { id: 'asc3', title: 'سلسلة الإمداد', description: 'بنية تحتية متقدمة ورقابة لوجستية.' },
          ],
        },
      },
    ],
    ...
    sections: [
      ...
      },
      {
        ...
        content: {
          ...
          description: 'فريقنا يساعدك في دخول السوق وإدارة دورة الحياة وفق المتطلبات التنظيمية.',
...
export function getFallbackPublicPage(slug: string, locale: Locale): PublicPageData | null {
