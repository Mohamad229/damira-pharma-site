...
const accentStyles: Record<
  AccentColor,
  { iconBg: string; iconColor: string; trendPositive: string; trendNegative: string }
> = {
  blue: {
    ...
    >
      ...
      <div
        className={cn(
          ...
          accent === 'blue' && 'bg-gradient-to-br from-[hsl(199_89%_48%/0.02)] to-transparent',
          accent === 'green' && 'bg-gradient-to-br from-[hsl(152_69%_41%/0.02)] to-transparent',
          accent === 'orange' && 'bg-gradient-to-br from-[hsl(27_96%_61%/0.02)] to-transparent',
          accent === 'purple' && 'bg-gradient-to-br from-[hsl(270_60%_55%/0.02)] to-transparent',
          accent === 'cyan' && 'bg-gradient-to-br from-[hsl(187_72%_45%/0.02)] to-transparent'
        )}
      />
