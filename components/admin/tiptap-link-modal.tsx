    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>Add a link to your content. Use absolute URLs or relative paths.</DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="space-y-2">
            <Label htmlFor="link-text" className="text-sm font-medium">
              Link Text <span className="text-xs text-muted-foreground">(optional)</span>
            </Label>
            <Input
              id="link-text"
