  ...
  return (
    <div className="relative mx-auto flex min-h-[68vh] w-full max-w-4xl flex-col items-center justify-center overflow-hidden px-4 text-center">
      ...
      <div className="rounded-[2rem] border border-border/80 bg-card/95 px-8 py-10 shadow-[var(--shadow-card)]">
        <p className="text-sm font-semibold uppercase tracking-[0.18em] text-destructive">500</p>
        <h1 className="mt-2 text-2xl font-semibold text-foreground">{tError('serverErrorTitle')}</h1>
        <p className="mt-2 max-w-md text-sm text-muted-foreground">{tError('serverErrorDescription')}</p>
      </div>
