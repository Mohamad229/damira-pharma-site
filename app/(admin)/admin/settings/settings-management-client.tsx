...
function toSiteSettingsFormState(settings: SiteSettings): SiteSettingsFormState {
  return {
...
export function SettingsManagementClient({
  ...
  const [categories, setCategories] = useState<CategoryLookupItem[]>(initialCategories);
  const [therapeuticAreas, setTherapeuticAreas] = useState<TherapeuticAreaLookupItem[]>(initialTherapeuticAreas);
  const [manufacturers, setManufacturers] = useState<ManufacturerLookupItem[]>(initialManufacturers);

  const [newCategory, setNewCategory] = useState<LookupFormState>(emptyLookupFormState);
  const [newTherapeuticArea, setNewTherapeuticArea] = useState<LookupFormState>(emptyLookupFormState);
  const [newManufacturer, setNewManufacturer] = useState<ManufacturerFormState>(emptyManufacturerFormState);

  const [editingCategoryId, setEditingCategoryId] = useState<string | null>(null);
  const [editingTherapeuticAreaId, setEditingTherapeuticAreaId] = useState<string | null>(null);
  const [editingManufacturerId, setEditingManufacturerId] = useState<string | null>(null);

  const [editingCategory, setEditingCategory] = useState<LookupFormState>(emptyLookupFormState);
  const [editingTherapeuticArea, setEditingTherapeuticArea] = useState<LookupFormState>(emptyLookupFormState);
  const [editingManufacturer, setEditingManufacturer] = useState<ManufacturerFormState>(emptyManufacturerFormState);
  ...
  async function withActionFeedback(
    ...
    try {
      ...
      if (result.error || !result.success) {
        const message = result.error || 'The requested change could not be completed.';
      ...
      const message = error instanceof Error ? error.message : 'Unexpected error while updating settings.';
      setStatusMessage({ tone: 'error', message });
      toast({
        title: 'Update failed',
        description: message,
      ...
      >
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Manage categories, therapeutic areas, and manufacturers used across product records.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
              ...
              <CardContent className="space-y-4">
                <form
                  ...
                  onSubmit={async (event) => {
                    ...
                    if (!name) {
                      setStatusMessage({ tone: 'error', message: 'Category name is required.' });
                      return;
                    }
                ...
                >
                  ...
                  <Input
                    ...
                    onChange={(event) =>
                      setNewCategory((prev) => ({ ...prev, nameAr: event.target.value }))
                    }
                      ...
                      {categories.map((category) => {
                        ...
                        return (
                          <tr key={category.id} className="border-b last:border-b-0">
                            ...
                            <td className="px-3 py-2 align-top">
                              {isEditing ? (
                                <Input
                                  ...
                                  onChange={(event) =>
                                    setEditingCategory((prev) => ({ ...prev, nameAr: event.target.value }))
                                  }
                            ...
                            <td className="px-3 py-2 align-top">{category.productCount}</td>
                            <td className="px-3 py-2 align-top">
                              {isEditing ? (
                                  ...
                                  <Button
                                    ...
                                    onClick={async () => {
                                      ...
                                      if (!name || !slug) {
                                        setStatusMessage({
                                          tone: 'error',
                                          message: 'Name and slug are required while editing a category.',
                                        });
                                        return;
                                      }
                                      ...
                                      const updated = await withActionFeedback(
                                        ...
                                        () =>
                                          updateCategory({
                                            id: category.id,
                                            name,
                                            nameAr: editingCategory.nameAr.trim() || null,
                                            slug,
                                          }),
                                      ...
                                      if (updated) {
                                        ...
                                        setEditingCategory(emptyLookupFormState());
                                      }
                                    }}
                                    disabled={updating}
                                  >
                                ...
                                <div className="flex items-center gap-2">
                                  ...
                                  <Button
                                    ...
                                    onClick={() => setDeleteConfirmKey(deleteKey)}
                                  >
            ...
            <Card className="border-dashed">
              <CardHeader>
                ...
                <CardDescription>Create, edit, and delete therapeutic areas.</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <form
                  className="grid gap-3 md:grid-cols-4"
                  onSubmit={async (event) => {
                    ...
                    if (!name) {
                      setStatusMessage({ tone: 'error', message: 'Therapeutic area name is required.' });
                      return;
                    }
                ...
                >
                  <Input
                    ...
                    onChange={(event) =>
                      setNewTherapeuticArea((prev) => ({ ...prev, name: event.target.value }))
                    }
                  ...
                  <Input
                    ...
                    onChange={(event) =>
                      setNewTherapeuticArea((prev) => ({ ...prev, nameAr: event.target.value }))
                    }
                    placeholder="Arabic name (optional)"
                  ...
                  <Input
                    ...
                    onChange={(event) =>
                      setNewTherapeuticArea((prev) => ({ ...prev, slug: event.target.value }))
                    }
                    placeholder="Slug (optional)"
                    aria-label="New therapeutic area slug"
                    disabled={pendingAction === 'therapeutic-area-create'}
                  />
                  <Button type="submit" disabled={pendingAction === 'therapeutic-area-create'}>
                      ...
                      {therapeuticAreas.map((area) => {
                        ...
                        return (
                          <tr key={area.id} className="border-b last:border-b-0">
                            <td className="px-3 py-2 align-top">
                              {isEditing ? (
                                <Input
                                  ...
                                  onChange={(event) =>
                                    setEditingTherapeuticArea((prev) => ({ ...prev, name: event.target.value }))
                                  }
                            ...
                            <td className="px-3 py-2 align-top">
                              {isEditing ? (
                                <Input
                                  ...
                                  onChange={(event) =>
                                    setEditingTherapeuticArea((prev) => ({ ...prev, nameAr: event.target.value }))
                                  }
                            ...
                            <td className="px-3 py-2 align-top">
                              {isEditing ? (
                                <Input
                                  ...
                                  onChange={(event) =>
                                    setEditingTherapeuticArea((prev) => ({ ...prev, slug: event.target.value }))
                                  }
                            ...
                            <td className="px-3 py-2 align-top">{area.productCount}</td>
                            <td className="px-3 py-2 align-top">
                              {isEditing ? (
                                <div className="flex items-center gap-2">
                                  <Button
                                    size="sm"
                                    onClick={async () => {
                                      const name = editingTherapeuticArea.name.trim();
                                      const slug = editingTherapeuticArea.slug.trim();
                                      ...
                                      const updated = await withActionFeedback(
                                        ...
                                        () =>
                                          updateTherapeuticArea({
                                            id: area.id,
                                            name,
                                            nameAr: editingTherapeuticArea.nameAr.trim() || null,
                                            slug,
                                          }),
                                      ...
                                      if (updated) {
                                        ...
                                        setEditingTherapeuticArea(emptyLookupFormState());
                                      }
                                    }}
                                    disabled={updating}
                                  >
            ...
            <Card className="border-dashed">
              <CardHeader>
                ...
                <CardDescription>Create, edit, and delete manufacturers.</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <form
                  className="grid gap-3 md:grid-cols-4"
                  onSubmit={async (event) => {
                    ...
                    if (!name) {
                      setStatusMessage({ tone: 'error', message: 'Manufacturer name is required.' });
                      return;
                    }
                ...
                >
                  <Input
                    ...
                    onChange={(event) =>
                      setNewManufacturer((prev) => ({ ...prev, name: event.target.value }))
                    }
                  ...
                  <Input
                    ...
                    onChange={(event) =>
                      setNewManufacturer((prev) => ({ ...prev, slug: event.target.value }))
                    }
                    placeholder="Slug (optional)"
                  ...
                  <Input
                    ...
                    onChange={(event) =>
                      setNewManufacturer((prev) => ({ ...prev, country: event.target.value }))
                    }
                    placeholder="Country (optional)"
                    aria-label="New manufacturer country"
                    disabled={pendingAction === 'manufacturer-create'}
                  />
                  <Button type="submit" disabled={pendingAction === 'manufacturer-create'}>
                  ...
                  <table className="w-full text-sm">
                    ...
                    <tbody>
                      {manufacturers.map((manufacturer) => {
                        const isEditing = editingManufacturerId === manufacturer.id;
                        ...
                        return (
                          <tr key={manufacturer.id} className="border-b last:border-b-0">
                            <td className="px-3 py-2 align-top">
                              {isEditing ? (
                                <Input
                                  value={editingManufacturer.name}
                                  onChange={(event) =>
                                    setEditingManufacturer((prev) => ({ ...prev, name: event.target.value }))
                                  }
                            ...
                            <td className="px-3 py-2 align-top">
                              {isEditing ? (
                                <Input
                                  ...
                                  onChange={(event) =>
                                    setEditingManufacturer((prev) => ({ ...prev, slug: event.target.value }))
                                  }
                            ...
                            <td className="px-3 py-2 align-top">
                              {isEditing ? (
                                <Input
                                  ...
                                  onChange={(event) =>
                                    setEditingManufacturer((prev) => ({ ...prev, country: event.target.value }))
                                  }
                            ...
                            <td className="px-3 py-2 align-top">{manufacturer.productCount}</td>
                            <td className="px-3 py-2 align-top">
                              {isEditing ? (
                                <div className="flex items-center gap-2">
                                  <Button
                                    ...
                                    onClick={async () => {
                                      ...
                                      const slug = editingManufacturer.slug.trim();
                                      ...
                                      const updated = await withActionFeedback(
                                        ...
                                        () =>
                                          updateManufacturer({
                                            ...
                                            name,
                                            slug,
                                            country: editingManufacturer.country.trim() || null,
                                          }),
                                      ...
                                      if (updated) {
                                        ...
                                        setEditingManufacturer(emptyManufacturerFormState());
                                      }
                                    }}
                                    disabled={updating}
                                  >
      ...
      >
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Configure branding, contact details, and default SEO values used across the website.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form
            ...
            >
              <div className="grid gap-5 md:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(event) =>
                      setSiteSettings((prev) => ({ ...prev, siteName: event.target.value }))
                    }
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(event) =>
                      setSiteSettings((prev) => ({ ...prev, siteTagline: event.target.value }))
                    }
              ...
              <div className="grid gap-5 md:grid-cols-2">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(event) =>
                      setSiteSettings((prev) => ({ ...prev, contactPhone: event.target.value }))
                    }
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  onChange={(event) =>
                    setSiteSettings((prev) => ({ ...prev, contactAddress: event.target.value }))
                  }
                  rows={3}
              ...
              <div className="grid gap-5 md:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(event) =>
                      setSiteSettings((prev) => ({ ...prev, seoDefaultTitle: event.target.value }))
                    }
                ...
                <div className="space-y-2">
                  <Label htmlFor="seo-default-description">Default SEO description</Label>
                  <Textarea
                    id="seo-default-description"
                    value={siteSettings.seoDefaultDescription}
                    onChange={(event) =>
                      setSiteSettings((prev) => ({ ...prev, seoDefaultDescription: event.target.value }))
                    }
                    rows={3}
              ...
              <div className="flex items-center justify-end gap-2 pt-1">
                <Button
                  type="submit"
                  className="gap-2"
                  disabled={!siteSettingsDirty || pendingAction === 'site-settings-save'}
                >
