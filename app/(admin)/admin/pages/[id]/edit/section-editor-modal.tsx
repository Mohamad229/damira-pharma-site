...
const HeroSectionEditor = lazy(() =>
  import('@/app/(admin)/admin/pages/sections/hero-section-editor').then((m) => ({
    default: m.HeroSectionEditor,
  }))
);
const TextSectionEditor = lazy(() =>
  import('@/app/(admin)/admin/pages/sections/text-section-editor').then((m) => ({
    default: m.TextSectionEditor,
  }))
);
const CardsSectionEditor = lazy(() =>
  import('@/app/(admin)/admin/pages/sections/cards-section-editor').then((m) => ({
    default: m.CardsSectionEditor,
  }))
);
const StatsSectionEditor = lazy(() =>
  import('@/app/(admin)/admin/pages/sections/stats-section-editor').then((m) => ({
    default: m.StatsSectionEditor,
  }))
);
const FeaturesSectionEditor = lazy(() =>
  import('@/app/(admin)/admin/pages/sections/features-section-editor').then((m) => ({
...
const ImageTextSectionEditor = lazy(() =>
  import('@/app/(admin)/admin/pages/sections/image-text-section-editor').then((m) => ({
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>Update the section content below</DialogDescription>
