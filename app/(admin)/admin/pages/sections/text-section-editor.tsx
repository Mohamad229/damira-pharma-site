...
export function TextSectionEditor({
  ...
  const [backgroundColor, setBackgroundColor] = useState<'white' | 'light-gray' | 'blue' | 'none'>(
    ...
    <div className="space-y-4">
      ...
      <div>
        ...
        <Select
          ...
          onChange={(e) =>
            setBackgroundColor(e.target.value as 'white' | 'light-gray' | 'blue' | 'none')
          }
          disabled={isLoading}
          className="mt-1"
        >
      ...
      >
        ...
        >
          <h2 className="text-2xl font-bold mb-4">{title || 'Section Title'}</h2>
