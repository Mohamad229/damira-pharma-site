...
export function ImageTextSectionEditor({
  ...
  const [image, setImage] = useState<MediaWithUser | null>(initialData?.image || null);
    ...
    <div className="space-y-4">
      ...
      <div>
        ...
        <Select
          id="image-ratio"
          value={imageRatio}
          onChange={(e) => setImageRatio(e.target.value as '1:1' | '16:9' | '4:3')}
          disabled={isLoading}
          className="mt-1"
        >
          ...
          >
            ...
            <div className="flex-1 prose dark:prose-invert text-sm max-w-none">
              {content ? (
                ...
                <p className="text-muted-foreground">Content preview will appear here</p>
              )}
            </div>
          </div>
        </div>
