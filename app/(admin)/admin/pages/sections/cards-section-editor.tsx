...
export function CardsSectionEditor({
  ...
  const [cardsPerRow, setCardsPerRow] = useState<number>(initialData?.cardsPerRow || 3);
  ...
  return (
    <div className="space-y-4">
      ...
      <DynamicArrayField
        ...
        disabled={isLoading}
      />
      {errors.cards && <p className="text-xs text-red-500 mt-1">{errors.cards}</p>}
