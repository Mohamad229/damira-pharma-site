    ...
    <div className="space-y-4">
      ...
      <div>
        ...
        <Input
          ...
          className="mt-1"
        />
        <p className="text-xs text-muted-foreground mt-1">Optional. Leave blank to hide button.</p>
      </div>
      ...
      <div>
        ...
        <Input
          ...
          className="mt-1"
        />
        <p className="text-xs text-muted-foreground mt-1">Optional. Must be paired with button text.</p>
      </div>
      ...
      <div>
        <Label htmlFor="hero-opacity" className="text-sm font-medium">
          Overlay Opacity
          <span className="text-muted-foreground ml-2">({overlayOpacity}%)</span>
        </Label>
        <input
          id="hero-opacity"
          type="range"
        ...
        />
        <p className="text-xs text-muted-foreground mt-1">Controls darkness of background overlay.</p>
      </div>
      ...
      <div className="flex gap-2 justify-end pt-4 border-t border-border mt-6">
        ...
        <Button onClick={handleSave} disabled={isLoading || Object.keys(errors).length > 0} className="gap-2">
