...
export function UsersTableClient({ initialData, currentUserId }: UsersTableClientProps) {
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b bg-muted/50">
              <th className="h-11 px-4 text-left font-semibold text-foreground">Name</th>
              <th className="h-11 px-4 text-left font-semibold text-foreground">Email</th>
              <th className="h-11 px-4 text-left font-semibold text-foreground">Role</th>
              <th className="h-11 px-4 text-left font-semibold text-foreground">Status</th>
              <th className="h-11 px-4 text-left font-semibold text-foreground">Updated</th>
              <th className="h-11 px-4 text-left font-semibold text-foreground">Actions</th>
            </tr>
          </thead>
          <tbody>
            {users.map((user) => {
              ...
              return (
                <tr key={user.id} className="border-b last:border-b-0 hover:bg-muted/40">
                  ...
                  <td className="h-14 px-4 align-middle text-muted-foreground">{user.email}</td>
